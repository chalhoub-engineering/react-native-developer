...
Use [EAS Build](https://docs.expo.dev/build/introduction/) to build your application for iOS and Android, and publish an [EAS Update](https://docs.expo.dev/eas-update/introduction/) (OTA) to it
