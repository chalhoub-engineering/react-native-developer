Expo / React Native Developer Test

Create an Expo / React Native application, based on provided layout.
...
Create an Expo / React Native application based on /layout
...
Required data: main product data (image URL, title, price, available sizes, colors description) see more products (products image URLs)

STEP 4

Create my account screen

We don't need an identity system, log-in, registration screens, let's assume a user is already logged in. Use Rick and Morty API to get user data
...
Use EAS Build to build your application for iOS and Android, and publish an EAS Update (OTA) to it
